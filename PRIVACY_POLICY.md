...
- **Referrers**: Source websites that led to your site
- **Timestamps**: When visits occurred
- **Technical Information**: Browser type, screen resolution, device type
...
Since the service is self-hosted, data transfer policies depend on your hosting location and applicable laws.

## 9. Children's Privacy

RAT Analytics is not intended for use by children under 13. We do not knowingly collect information from children.

## 10. Changes to This Policy

We may update this Privacy Policy periodically. We will notify users of significant changes through the dashboard or repository updates.

## 11. Compliance

RAT Analytics is designed to comply with:
